document.addEventListener('DOMContentLoaded', () => {
  ...
  // 1 metro = 100 pixels (ajuste conforme desejar)
  ...
  let forceLevel = 2;
  let manchas = [];
  // Origem em metros (x, y, z)
  let origem = { x: pxToMeters(canvas.width / 2), y: pxToMeters(canvas.height * 0.4), z: 1.20 }; // z: 1.2m = 120px
